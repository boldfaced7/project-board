...
class ArticleControllerTest {
    ...
    public void givenSearchKeyword_whenSearchingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        given(articleService.searchArticles(eq(searchType), eq(searchValue), any(Pageable.class)))
                .willReturn(Page.empty());
        given(paginationService.getPaginationBarNumber(anyInt(), anyInt()))
    ...
    @Test
    void givenPagingAndSortingParams_whenSearchingArticlesView_thenReturnsArticlesView() throws Exception {        // Given
        ...
        given(paginationService.getPaginationBarNumber(pageable.getPageNumber(), Page.empty().getTotalPages()))
